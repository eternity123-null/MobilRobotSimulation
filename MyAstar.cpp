...
namespace pathplanning
{
    ...
    Node *Astar::FindPath() // return tail node
    {
        ...
        while (!OpenList.empty())
        {
            ...
            Point CurPoint = OpenList.top().second; // second elem in pair
            OpenList.pop();
            ...
            for (int k = 0; k < neighbor.rows; k++) // neighbor.rows=8
            {
